...
| Metabolism of xenobiotics by cytochrome P450 | hsa00980 | Coerente com hsa00982 (GSEA significativa, NES ≈ −1,72) |
| Retinol metabolism | hsa00830 | GSEA significativa (NES ≈ −1,79) — metabolismo lipídico |
| Chemical carcinogenesis — DNA adducts | hsa05204 | GSEA significativa (NES ≈ −1,72) |
...
- As vias marcadas com "já enriquecida" foram testadas pelo script
  `scripts/pipelines/03_analise_reactome.R` (resultados em `outputs/enrichment/Reactome_*`).
